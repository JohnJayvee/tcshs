<div class="container">
    <?php $this->Main_model->banner("Upload student grade", "$uploadSchoolYear"); ?>
...
<div class="row col-md-12" id="cardBody">
        ...
        <div class="m-1">
            <div class="card" style="width: 18rem; height:auto; ">
                <div class="card-body">
                    ...
                    <?php $enter = base_url() . "shs/selectQuarter?subjectId=$row->sh_subject_id&sectionId=$row->sh_section_id&yearLevel=$row->year_level&strandId=$row->strand_id&semester=$row->semester"; ?>
            ...
            <div class="m-1">
                ...
                <h5 align="center" class="bg-dark p-1" style="color:white;">Special class</h5>
                    <div class="card-body">
                        ...
                        <?php $enter = base_url() . "shs/selectQuarter?customClassId=$row->id&semester=$row->semester&subjectId=$row->sh_subject_id"; ?>
                        <a href="<?= $enter ?>"><button class="btn btn-primary col-md-12"><i class="fas fa-eye"></i>&nbsp; Enter</button></a>
                    </div>
                </div>
            </div>
    ...
    <?php $back = base_url() . "shs/uploadGrade" ?>
<a href="<?= $back ?>"><button class="btn btn-secondary col-md-12"><i class="fas fa-arrow-left"></i>&nbsp; Back</button></a>
</div>
<?php $sortBySubjectsPs = base_url() . "shs/sortBySubjectsPsUploadGrade" ?>

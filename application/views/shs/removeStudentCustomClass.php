<div class="container">
    ...
    <p style="font-size:30px">Are you sure you want to remove <b><?= $studentName ?></b> From this class?</p>
    <?php 
        $back = base_url() . "shs/viewSpecialClass?customClassId=$customClassId";
        $confirm = base_url() . "shs/removeStudentCustomClass?customClassId=$customClassGroupId&confirm=1";
    ?>

        ...
        <table class="table table-bordered" id="dataTable" cellspacing="0" width="100%">
            ...
            <?php foreach ($classTable->result() as $row) {?>
                <tr>
                    ...
                    <td>
                    <?php $enter = base_url() . "SearchStudent/studentSearchAttendance?subjectId=$row->subject_id&yearLevelId=$yearLevelId&sectionId=$sectionId&facultyId=$row->faculty_id&studentId=$studentId&classId=$row->class_id"; ?>

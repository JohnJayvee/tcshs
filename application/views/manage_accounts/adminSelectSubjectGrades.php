        ...
        <table class="table table-bordered" id="dataTable" width="100%">
            ...
            <?php foreach ($classTable->result() as $row) {?>
                ...
                <tr align="center">
                    ...
                    <td>
                    <?php $grade = base_url() . "searchStudent/adminViewGrades?subjectId=$row->subject_id&sectionId=$sectionId&facultyId=$row->faculty_id&studentId=$studentId&yearLevelId=$yearLevelId";?>

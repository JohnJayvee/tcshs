...
<div class="container">
	...
	<div class="bg-warning p-3 m-3">
		<h1 align="center">Account Batch Registration</h1>
		<hr>
		<h2 align="center">For <u>Junior High school</u> faculty members</h2>
		<div style="margin-bottom:20px"></div>



		<?php $form = base_url() . 'RegisterBatch/facultyBatchRegister' ?>
		<?php

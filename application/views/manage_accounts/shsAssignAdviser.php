<div class="container">
    ...
    <center class="bg-warning col-md-12 p-3">
        <h1>Manage senior highschool section Advisers</h1>
        <hr width="50%">
        <h3><?= $yearLevelName ?> <u><?= $sectionName ?></u></h3>
    </center>
    ...
    <form action="" method="post">
                ...
                <tbody>
                    ...
                    foreach ($facultyTable->result() as $row) { ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                if ($this->Main_model->checkAdviserIsAssigned($row->account_id, 2)) { ?>
        ...
        $back = base_url() . "shs/manageAdviserSelectSection?yearLevelId=$yearLevelId&strandId=$strandId";
        ?>
        <div class="row">
            <div class="col-md-6">

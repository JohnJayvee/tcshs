<div class="container">
    ...
    <?php $form = base_url() . "manage_user_accounts/ShsAssignAdviser?yearLevel=$yearLevelId&sectionId=$sectionId&strandId=$strandId" ?>
    <form action="<?= $form ?>" method="post">
        ...
        $back = base_url() . "manage_user_accounts/ShsAssignAdviser?yearLevel=$yearLevelId&strandId=$strandId";
        ?>
        <div class="row">
            <div class="col-md-6">

...
<div style="margin-bottom: 40px"></div>
 <div class="container">
	...
	<h1><?= $facultyName ?></h1>
    <hr width="50%">
    <span style="font-size:30px"><b><?= $studentNameFullName ?></b> | <b><?= $yearLevelName ?></b> | <b><?= $sectionName ?></b></span>
        ...
        <table class="table table-bordered" id="dataTable" width="100%">
            ...
            <?php foreach ($classTable->result() as $row) {?>
                ...
                <tr align="center">
                    ...
                    <td>
                    <?php $grade = base_url() . "searchStudent/attendanceRecordSearchAdmin?subjectId=$row->subject_id&sectionId=$sectionId&facultyId=$row->faculty_id&studentId=$studentId&yearLevelId=$yearLevelId&classId=$row->class_id";?>

...
<?php $url = base_url() . 'assets/main_page_2/' ?>
<script src="<?= $url ?>js/breakpoints.js"></script>
<script src="<?= $url ?>js/jquery/jquery-1.11.1.min.js"></script>
<!-- bootstrap -->
<script src="<?= $url ?>js/scrollspy.js"></script>
<script src="<?= $url ?>js/bootstrap-progressbar/bootstrap-progressbar.js"></script>
<script src="<?= $url ?>js/bootstrap.min.js"></script>
<!-- end bootstrap -->
<script src="<?= $url ?>js/masonry.pkgd.min.js"></script>
<script src='<?= $url ?>js/imagesloaded.pkgd.min.js'></script>
<!-- bxslider -->
<script src="<?= $url ?>js/bxslider/jquery.bxslider.min.js"></script>
<!-- end bxslider -->
<!-- flexslider -->
<script src="<?= $url ?>js/flexslider/jquery.flexslider.js"></script>
<!-- end flexslider -->
<!-- smooth-scroll -->
<script src="<?= $url ?>js/smooth-scroll/SmoothScroll.js"></script>
<!-- end smooth-scroll -->
<!-- carousel -->
...
<script src="<?= $url ?>js/rs-plugin/videojs/video.js"></script>

<!-- jquery ui -->
<script src="<?= $url ?>js/jqueryui/jquery-ui.js"></script>
<!-- end jquery ui -->
<script type="text/javascript" language="javascript"
        src="http://maps.google.com/maps/api/js?sensor=false&key=AIzaSyCfVS1-Dv9bQNOIXsQhTSvj7jaDX7Oocvs"></script>
<!-- Modules -->
<script src="<?= $url ?>js/modules/sliders.js"></script>
<script src="<?= $url ?>js/modules/ui.js"></script>
<script src="<?= $url ?>js/modules/retina.js"></script>
<script src="<?= $url ?>js/modules/animate-numbers.js"></script>
<script src="<?= $url ?>js/modules/parallax-effect.js"></script>
<script src="<?= $url ?>js/modules/settings.js"></script>
<script src="<?= $url ?>js/modules/maps-google.js"></script>
<script src="<?= $url ?>js/modules/color-themes.js"></script>
<!-- End Modules -->

<!-- Audio player -->
<script type="text/javascript" src="<?= $url ?>js/audioplayer/js/jquery.jplayer.min.js"></script>
<script type="text/javascript" src="<?= $url ?>js/audioplayer/js/jplayer.playlist.min.js"></script>
<script src="<?= $url ?>js/audioplayer.js"></script>
<!-- end Audio player -->

<!-- radial Progress -->
<script src="<?= $url ?>js/radial-progress/jquery.easing.1.3.js"></script>
<script src="<?= $url ?>http://cdnjs.cloudflare.com/ajax/libs/d3/3.4.13/d3.min.js"></script>
<script src="<?= $url ?>js/radial-progress/radialProgress.js"></script>
<script src="<?= $url ?>js/progressbars.js"></script>
<!-- end Progress -->

<!-- Google services -->
<script type="text/javascript" src="https://www.google.com/jsapi?autoload={'modules':[{'name':'visualization','version':'1','packages':['corechart']}]}"></script>
<script src="<?= $url ?>js/google-chart.js"></script>
<!-- end Google services -->
<script src="<?= $url ?>js/j.placeholder.js"></script>

<!-- Fancybox -->
<script src="<?= $url ?>js/fancybox/jquery.fancybox.pack.js"></script>
<script src="<?= $url ?>js/fancybox/jquery.mousewheel.pack.js"></script>
<script src="<?= $url ?>js/fancybox/jquery.fancybox.custom.js"></script>
<!-- End Fancybox -->
<script src="<?= $url ?>js/user.js"></script>
<script src="<?= $url ?>js/timeline.js"></script>
<script src="<?= $url ?>js/fontawesome-markers.js"></script>
<script src="<?= $url ?>js/markerwithlabel.js"></script>
<script src="<?= $url ?>js/cookie.js"></script>
<script src="<?= $url ?>js/loader.js"></script>
<script src="<?= $url ?>js/scrollIt/scrollIt.min.js"></script>
<script src="<?= $url ?>js/modules/navigation-slide.js"></script>

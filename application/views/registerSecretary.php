...
<body>
    ...
    <div style="margin-bottom:30px"></div>
        <center class="bg-primary p-3">
            ...
            <h2>Register secretary administrator's account</h2>
        </center>
        ...
        <form action="" method="post" onsubmit="return checkMobileNumber()">
            ...
            <div class="form-group m-1">
                <input type="checkbox" name="confirmTeacher" id="" class="">
                <label style="margin-left:20px;font-size:20px">Secretary will also be a teacher</label>
            </div>
            <div style="margin-bottom:20px"></div>

            <?php $back = base_url() . "login/brandNewStart" ?>
            <div class="row">
